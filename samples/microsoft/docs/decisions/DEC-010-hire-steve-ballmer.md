...
type: decision
id: DEC-010
title: Hire Steve Ballmer as First Business Manager
status: accepted
created: 1980-06-11
updated: 1980-06-11
authors: [bg]
...
1. **Operational excellence** — Microsoft scaled professionally
2. **Sales machine** — Ballmer built enterprise sales organization
3. **Gates complement** — Product visionary + business executor
4. **Loyalty** — Ballmer stayed 34 years

### Negative

1. **Equity dilution** — 8.5% was substantial
2. **Gate-Ballmer dependency** — Company relied heavily on their partnership
3. **Succession complexity** — Ballmer's eventual CEO tenure was controversial
