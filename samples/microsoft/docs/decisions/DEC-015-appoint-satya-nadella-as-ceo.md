...
type: decision
id: DEC-015
title: Appoint Satya Nadella as CEO
status: accepted
created: 2014-02-04
updated: 2014-02-04
authors: [billg, board]
tags: [cloud, leadership, succession, transformation]
links:
  supersedes: [DEC-014]
  superseded_by: []
  depends_on: []
...
1. **Stock price**: $38 → $400+ (10x in 10 years)
2. **Cloud dominance**: Azure became #2 cloud (challenging AWS)
3. **Culture transformation**: "Learn-it-all" replaced "know-it-all"
4. **Strategic acquisitions**: LinkedIn, GitHub, Activision
5. **AI leadership**: OpenAI partnership positioned Microsoft for AI era

### Negative

1. **Mobile abandoned**: Windows Phone killed (correct decision, still a loss)
2. **Consumer retreat**: Xbox survived, but consumer focus diminished
3. **Ballmer legacy**: Narrative unfairly harsh on predecessor's contributions
